...
if (isset($_POST["submit"])) {
    ...
    $query = "SELECT id, username, password, name, email, join_date FROM users WHERE email='$email'";
...
<body id="_5">
    ...
    <div id="content">
        <center>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                <input name="email" id="user" type="text" title="Email" placeholder="Email" required>
                ...
                <a href="reset.php" id="trouble"><span>Having Trouble in login ? Reset password</span></a>
            </form>
        </center>
    </div>
    ...
    <!-- Footer -->
    <div id="footer">
        &copy; 2023 &bull; USIM News Content by Irfan .
    </div>
